...
class Sale(SalesModel, table=True):
    ...
    def update(self, firstname=None, lastname=None, products=None, selling_price=None, amount_paid=None):
        ...
        for update in product_updates:
            product = next((product for product in self.products if product.sku == update['sku']), None)
            if product is None:
